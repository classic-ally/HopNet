...
RustBuffer uniffi_ingress_ffi_fn_method_ingresssession_ensure_personal_library(uint64_t ptr, RustBuffer blob_root, RustBuffer sidecar_root_remote, RustCallStatus *_Nonnull out_status
);
#endif
