...
# RFC-026 S1: the daemon's committed Info.plist must agree with the
# workspace version — fail here at stage 0, not at staging time.
bash "$SCRIPT_DIR/version.sh" --check
